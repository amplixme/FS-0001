...
function PostDetail() {
    ...
    return (
        <div className="mx-auto max-w-3xl px-6 py-10">
            ...
            <Link to="/" className="inline-flex items-center gap-1 text-sm text-outline hover:text-primary mb-8">
                ← Volver a inicio
            </Link>
            ...
            <div className="flex items-center gap-3 mb-8">
                ...
                <div className="flex flex-col">
                    <span className="text-sm font-semibold text-on-surface">{post.author?.name}</span>
            ...
            {isAuthor && (
                <div className="flex items-center justify-end gap-3 mt-16 pt-8 border-t border-outline-variant/20">
                    <button onClick={() => navigate(`/posts/${id}/edit`)} className="flex items-center gap-2 px-5 py-2 rounded-full border border-gray-400 text-gray-800 hover:bg-gray-100 transition-all text-sm font-semibold">
                        <Pencil size={16} />
                        Editar
                    </button>
